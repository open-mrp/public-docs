...
function ScrollProvider({
    ...
    // Keep the active TOC item in view within the scroll container while allowing manual scroll
    useLayoutEffect(() => {
        ...
        // Find nearest scrollable ancestor (the sticky nav with overflow-y-auto)
        ...
        // Simple auto-scroll to keep active item in view
        const padding = 12;
        const parentRect = scrollParent.getBoundingClientRect();
        const elRect = activeEl.getBoundingClientRect();
        const isAbove = elRect.top < parentRect.top + padding;
        const isBelow = elRect.bottom > parentRect.bottom - padding;
    ...
    return (
        <div
            ref={containerRef}
            className="min-h-0 overflow-y-auto flex-1 overscroll-none"
            style={{
