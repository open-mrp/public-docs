...
route: '/api-reference/item-categories-management/retrieve-item-category'
...
<ApiEndpoint tagSlug="item-categories-management" endpointSlug="retrieve-item-category" />
