...
route: '/api-reference/scanning-stations-management/retrieve-scanning-station'
...
<ApiEndpoint tagSlug="scanning-stations-management" endpointSlug="retrieve-scanning-station" />
