...
Augno calculates the **cost of goods sold (COGS)** for parts and products in real time from <InternalLink pathKey="buildProducts.bom.productionSteps" text="production step" /> definitions, giving you visibility into material, labor, and overhead costs as you manufacture.
