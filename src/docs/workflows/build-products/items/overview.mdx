...
**Items** are the objects you buy (materials), make (parts), or sell (products) to a <InternalLink pathKey="generateSales.customer.overview" text="customer" />. They are critical to most aspects of OpenMRP.
