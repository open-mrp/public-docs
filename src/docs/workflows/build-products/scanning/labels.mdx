...
**Labels** identify <InternalLink pathKey="buildProducts.production.batches" text="batches" /> as they move through production. Augno supports two label formats and four sizes, configured per <InternalLink pathKey="buildProducts.scanning.scanningStations" text="scanning station" />.
