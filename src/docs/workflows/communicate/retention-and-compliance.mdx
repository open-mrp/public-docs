...
- for email-bridged cases, the delivery metadata OpenMRP recorded for each mail — including the external sender's address, the subject line, and the raw message stored in object storage when it arrived.
