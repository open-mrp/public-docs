...
**Sandboxes** are isolated copies of your OpenMRP environment for testing and development. Each sandbox has its own data, settings, and API keys, completely separate from your production account. Manage sandboxes from the <InternalLink pathKey="frontend.sandboxes" text="Sandboxes" /> page.
