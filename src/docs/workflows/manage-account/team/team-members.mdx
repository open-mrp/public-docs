...
**Team members** are the users who have access to your OpenMRP account. From the <InternalLink pathKey="frontend.team" text="Team page" />, anyone whose role grants the `team` permissions — admins always qualify — can invite new users, assign roles and departments, and lock or remove members who no longer need access.
