...
- **Configure <InternalLink pathKey="generateSales.customerSetup.defaultCarriers" text="carriers" /> in OpenMRP**: set up carriers and service levels that map to your Shippo accounts
