...
When you select a customer on a new <InternalLink pathKey="generateSales.salesOrder.create" text="sales order" />, Augno automatically populates two contact lists:
