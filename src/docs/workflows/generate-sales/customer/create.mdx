...
To create a <InternalLink pathKey="generateSales.customer.overview" text="customer" /> in OpenMRP, you need to have <InternalLink pathKey="generateSales.customerSetup.customerGroups" text="created a customer group" />.
