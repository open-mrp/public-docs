...
When a customer's payment terms are **Prepaid**, Augno warns the team to collect payment before <InternalLink pathKey="generateSales.salesOrder.issue" text="issuing the order" />. This prevents orders from entering fulfillment without payment.
