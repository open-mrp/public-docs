...
```bash
curl https://api.augno.io/v1/core/request-logs \
  -H "Authorization: Bearer YOUR_API_KEY"
```

For filtering options and response details, see the <InternalLink pathKey="apiReference.requestLogManagement" text="Request Log Management API reference" />.
