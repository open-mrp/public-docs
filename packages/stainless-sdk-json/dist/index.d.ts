...
//#endregion
//#region spec/generateSpec.d.ts
declare const previewWorkerCode: string;
type LanguageGenerateQuery = {
  mode: 'exclude' | 'only';
  list: SpecLanguage[];
};
type GenerateSpecRawInputs = {
  oasStr: string;
  configStr: string;
  languageOverrides: LanguageGenerateQuery | null;
  stainlessProject: string;
  versionInfo: Record<SpecLanguage, string> | null;
};
declare function generateSpecFromStrings({
  oasStr,
  configStr,
  stainlessProject,
  languageOverrides,
  versionInfo
}: GenerateSpecRawInputs): Promise<{
  sdkJson: Spec;
  languages: ("node" | "typescript" | "python" | "go" | "java" | "kotlin" | "ruby" | "terraform" | "cli" | "php" | "csharp" | "sql" | "http" | "openapi")[];
}>;
type SpecWithAuth = Awaited<ReturnType<typeof generateSpecFromStrings>>;
//#endregion
//#region spec/worker.d.ts
type ParsedConfig = {
  docs: {
    title?: string | undefined;
    favicon?: string | undefined;
...
//#endregion
export { type GenerateSpecRawInputs, type LanguageGenerateQuery, type ParsedConfig, type SpecWithAuth, generateSpecFromStrings, previewWorkerCode };